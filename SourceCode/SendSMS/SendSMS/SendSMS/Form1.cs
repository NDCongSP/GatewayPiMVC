...
namespace SendSMS
{
    public partial class Form1 : Form
    {
        ...
        //    Debug.WriteLine("Khởi tạo USB3G");
            ...
            //GateWay.SMS.Khoitao();
            //Debug.WriteLine($"Com SMS {myPLCpi.SMS.Port_USB3G}| Khoi Tao {myPLCpi.SMS.Khoitao()}");
        ...
        {
            myPLCpi.SMS.Port_USB3G = textBox3.Text.Trim();
            label4.Text = myPLCpi.SMS.Khoitao() + "|" + myPLCpi.SMS.Port_USB3G;
        }
            ...
            if (bangSMS != null && bangSMS.Rows.Count > 0)
            {
                for (int i = 0; i < bangSMS.Rows.Count; i++)
                {
                 ...
                 $"\nHigh Level: {bangSMS.Rows[i][5].ToString()}";
                    ...
                    if (myPLCpi.SMS.GuiSMS(SMSString, "aaaaa") == "Good")
                    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Debug.WriteLine(myPLCpi.SMS.GuiSMS(textBox1.Text.Trim(), noidung));
                Thread.Sleep(2000);
            }
        }
